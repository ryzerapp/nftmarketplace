                  ...
                  <div className="col-xl-12">
                    <article>
                      ...
                      <ul className="post-metainfo  list-style">
                        <li><i className="flaticon-user-2"></i><a href="posts-by-author.html">Admin</a></li>
                        <li><i className="flaticon-chat-comment-oval-speech-bubble-with-text-lines"></i>3 Comments</li>
                      </ul>
                      <div className="post-img">
                        <img src="../images/blog/single-blog-1.jpg" alt="Image" />
                      </div>
                      <div className="post-para">
                        ...
                        <p>No sea takimata sanctus est Lorem <a href="index.html">Ipsum</a> dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et.</p>
                        <blockquote className="wp-block-quote">
                          <div className="wp-quote-text">
                            <p>"Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed cum fuga ab, eum numquam ea dolores quae takimata sanctus est Lorem amet ducimus Lorem ipsum, dolor sit amet consectetur adipisicing amet consequat uis aute irure"</p>
                          </div>
                          <span className="wp-quote-icon"><i className="flaticon-straight-quotes"></i></span>
                        </blockquote>
                        ...
                        <h3>Commodo Viverra Manas Accumsan Sit</h3>
                        <ol>
                        ...
                        <h3>How To licensing NFTs</h3>
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laboriosam in culpa dolorem. Eos sint aut suscipit ipsum dolor sit amet consectetur adipisicing elit eprehenderit dignissimos.</p>
                        <div className="post-img">
                          <img src="../images/blog/single-blog-2.jpg" alt="Image" />
                        </div>
                        ...
                        <ul className="content-feature-list style2 list-style mt-15">
                          <li>
                        ...
                        <div className="col-md-7 col-12">
                          <div className="post-tag">
                            ...
                            <ul className="tag-list list-style">
                              <li><a href="posts-by-tag.html">Music</a>,</li>
                              <li><a href="posts-by-tag.html">Vision</a>,</li>
                              <li><a href="posts-by-tag.html">Art</a></li>
                            </ul>
                          </div>
                        </div>
                    ...
                    <div className="post-author">
                      <div className="post-author-img">
                        <img src="../images/blog/author-1.jpg" alt="Image" />
                      </div>
                    ...
                    <div className="comment-box-wrap">
                      <div className="comment-box-title mb-30">
                      ...
                      <form action="#" className="comment-form">
                        ...
                        <div className="row align-items-center">
                          ...
                          <div className="col-md-12 mt-20">
                            <button className="btn style1">Post A Comment</button>
                          </div>
                        </div>
                      </form>
                    </div>
                    ...
                    <div className="sidebar">
                        ...
                        <div className="popular-post-widget">
                            ...
                            <div className="pp-post-info">
                              ...
                              <h6>
                                <a href="blog-details-no-sidebar.html">
                                  Announcing Our $100m Fund Raise
                                </a>
                              </h6>
                            </div>
                          </div>
                          <div className="pp-post-item">
                            ...
                            <div className="pp-post-info">
                              ...
                              <h6>
                                <a href="blog-details-no-sidebar.html">
                                  How To Sell Your First NFTs In Marketplace
                                </a>
                              </h6>
                            </div>
                          </div>
                          <div className="pp-post-item">
                            ...
                            <div className="pp-post-info">
                              ...
                              <h6>
                                <a href="blog-details-no-sidebar.html">
                                  5 Tips For Choosing The Best NFT Market
                                </a>
                              </h6>
                            </div>
                          </div>
                      ...
                      <div className="sidebar-widget tags">
                        ...
                        <div className="tag-list">
                          <ul className="list-style">
                            <li><a href="posts-by-tag.html">Virtual Art</a></li>
                            <li><a href="posts-by-tag.html">Music </a></li>
                            <li><a href="posts-by-tag.html">Trendy</a></li>
                            <li><a href="posts-by-tag.html">Art</a></li>
                            <li><a href="posts-by-tag.html">Modern</a></li>
                            <li><a href="posts-by-tag.html">Vintage</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
