          ...
          <div className='row pt-45'>
            <div className='col-lg-12'>
              ...
              <div className='single-content'>
                ...
                <ol style={style.ul}>
                  <li style={style.li}>Names </li>
                  <li style={style.li}>Usernames </li>
                  <li style={style.li}>Email addresses </li>
              ...
              <div className='single-content'>
                ...
                <ol style={style.ul}>
                  <li style={style.li}>To facilitate account creation and authentication and otherwise manage user accounts. We may process your information so you can create and log in to your account, as well as keep your account in working order. </li>
                  <li style={style.li}>To save or protect an individual's vital interest. We may process your information when necessary to save or protect an individual’s vital interest, such as to prevent harm. </li>
                 </ol>
              </div>
              ...
              <div className='single-content'>
                ...
                <ol style={style.ul}>
                  <li style={style.li}><b style={style.bold}> Consent. </b> We may process your information if you have given us permission to use your personal information for a specific purpose. You can withdraw your consent at any time. Click <a href='here'>here</a> to learn more.</li>
                ...
                <ol style={style.ul}>
                  <li style={style.li}>If collection is clearly in the interests of an individual and consent cannot be obtained in a timely way  </li>
                  <li style={style.li}>For investigations and fraud detection and prevention </li>
                  <li style={style.li}>For business transactions provided certain conditions are met  </li>
                  <li style={style.li}>If it is contained in a witness statement and the collection is necessary to assess, process, or settle an insurance claim </li>
                  <li style={style.li}>For identifying injured, ill, or deceased persons and communicating with next of kin  </li>
                  <li style={style.li}>If we have reasonable grounds to believe an individual has been, is, or may be victim of financial abuse </li>
                  <li style={style.li}>If it is reasonable to expect collection and use with consent would compromise the availability or the accuracy of the information and the collection is reasonable for purposes related to investigating a breach of an agreement or a contravention of the laws of Canada or a province </li>
                  <li style={style.li}>If disclosure is required to comply with a subpoena, warrant, court order, or rules of the court relating to the production of records </li>
                  <li style={style.li}>If it was produced by an individual in the course of their employment, business, or profession and the collection is consistent with the purposes for which the information was produced </li>
                  <li style={style.li}>If the collection is solely for journalistic, artistic, or literary purposes </li>
                  <li style={style.li}>If the information is publicly available and is specified by the regulations </li>
              ...
              <div className='single-content'>
                ...
                <ol style={style.ul}>
                  <li style={style.li}> <b style={style.bold}> Business Transfers. </b> We may share or transfer your information in connection with, or during negotiations of, any merger, sale of company assets, financing, or acquisition of all or a portion of our business to another company.  </li>
                </ol>
              </div>
              ...
              <div className='single-content'>
                ...
                <ol style={style.ul}>
                  <li style={style.li}>To request access and obtain a copy of your personal information, </li>
                  <li style={style.li}>To request rectification or erasure; </li>
                ...
                you have the right to withdraw your consent at any time. You can withdraw your consent at any 
                ...
                <b style={style.bold}> Opting out of marketing and promotional communications : </b>
                 ...
                 details provided in the section " HOW CAN YOU CONTACT US ABOUT THIS NOTICE?" below. You will then 
                 be removed from the marketing lists. However, we may still communicate with you — for example, to send 
              ...
              <div className='single-content'>
                ...
                signals has been finalized. As such, we do not currently respond to DNT browser signals or any other mechanism that 
                automatically communicates your choice not to be tracked online. If a standard for online tracking is adopted that we 
                ...
                We will make sure the data is not publicly displayed on the Services, but please be aware 
              ...
              <table style={style.table}>
                <tr style={style.tr}>
                  <th style={style.td}> Category </th>
                  <th style={style.td}> Examples </th>
                  <th style={style.td}> Collected </th>
                </tr>
                <tr style={style.tr}>
                  <td style={style.td}> A. Identifiers </td>
                  <td style={style.td}> Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address, and account name</td>
                  <td style={style.td}> NO </td>
                </tr>
                <tr style={style.tr}>
                  <td style={style.td}> B. Personal information categories listed in the California Customer Records statute</td>
                  <td style={style.td}> Name, contact information, education, employment, employment history, and financial information</td>
                  <td style={style.td}> YES</td>
                </tr>
                <tr style={style.tr}>
                  <td style={style.td}> C. Protected classification characteristics under California or federal law</td>
                  <td style={style.td}> Gender and date of birth</td>
                  <td style={style.td}> NO</td>
                </tr>
                <tr style={style.tr}>
                  <td style={style.td}> D. Commercial information</td>
                  <td style={style.td}> Transaction information, purchase history, financial details, and payment information</td>
                  <td style={style.td}> NO</td>
                </tr>
                <tr style={style.tr}>
                  <td style={style.td}> E. Biometric information</td>
                  <td style={style.td}> Fingerprints and voiceprints</td>
                  <td style={style.td}> NO</td>
                </tr>
                <tr style={style.tr}>
                  <td style={style.td}> F. Internet or other similar network activity</td>
                  <td style={style.td}> Browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications, systems, and advertisements</td>
                  <td style={style.td}> NO</td>
                </tr>
                <tr style={style.tr}>
                  <td style={style.td}> G. Geolocation data</td>
                  <td style={style.td}> Device location</td>
                  <td style={style.td}> NO</td>
                </tr>
                <tr style={style.tr}>
                  <td style={style.td}> H. Audio, electronic, visual, thermal, olfactory, or similar information</td>
                  <td style={style.td}> Images and audio, video or call recordings created in connection with our business activities</td>
                  <td style={style.td}> NO</td>
                </tr>
                <tr style={style.tr}>
                  <td style={style.td}> I. Professional or employment-related information</td>
                  <td style={style.td}> Business contact details in order to provide you our services at a business level or job title, work history, and professional qualifications if you apply for a job with us</td>
                  <td style={style.td}> NO</td>
                </tr>
                <tr style={style.tr}>
                  <td style={style.td}> J. Education Information</td>
                  <td style={style.td}> Student records and directory information</td>
                  <td style={style.td}> NO</td>
                </tr>
                <tr style={style.tr}>
                  <td style={style.td}> K. Inferences drawn from other personal information</td>
                  <td style={style.td}> Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example, an individual’s preferences and characteristics</td>
                  <td style={style.td}> NO</td>
                </tr>
              </table>
              <p>
              ...
              <ol style={style.ul}>
                  <li style={style.li}>Receiving help through our customer support channels; </li>
                  <li style={style.li}>Participation in customer surveys or contests; and </li>
                  <li style={style.li}>Facilitation in the delivery of our Services and to respond to your inquiries. </li>
              </ol>
              <p style={style.bold}>
              ...
              <ol style={style.ul}>
                  <li style={style.li}>Whether we collect and use your personal information; </li>
                  <li style={style.li}>The categories of personal information that we collect; </li>
                  <li style={style.li}>The purposes for which the collected personal information is used; </li>
                  <li style={style.li}>Whether we sell your personal information to third parties; </li>
                  <li style={style.li}>The categories of personal information that we sold or disclosed for a business purpose; </li>
              ...
              <p>
               ...
               <ol style={style.ul}>
                  <li style={style.li}>You may object to the processing of your personal information. </li>
                  <li style={style.li}>You may request correction of your personal data if it is incorrect or no longer relevant, or ask to restrict the processing of the information. </li>
              ...
              <div className='single-content'>
                ...
                <ol style={style.ul}>
                  <li style={style.li}>Cryptonium </li>
                  <li style={style.li}>Nikol </li>
