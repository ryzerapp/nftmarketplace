											...
											<div class="nk-block-text">
												...
												<a href="/play-nft-game" class="video-popup btn-play-wrap " data-animate="fadeInUp" data-delay=".4">
													...
													<div class="btn-play-text">
														<span class="text-sm">Play Game</span>
														<span class="text-xs">Just Play It.</span>
													</div>
												</a>
											</div>
										</div>
												...
												<div class="tab-pane fade show active" id="general-questions-19">
													<div class="accordion accordion-faq" id="faq-67">
														<div class="accordion-item accordion-item-s4 bg-theme-alt">
															<h5 class="accordion-title" data-toggle="collapse" data-target="#faq-67-1"> What is Cryptonium Crypto? <span class="accordion-icon accordion-icon-s2"></span>
															</h5>
															<div id="faq-67-1" class="collapse show" data-parent="#faq-67">
																<div class="accordion-content">
																	<p>Once Cryptonium period is launched, You can purchased Token with Etherum, Bitcoin or Litecoin. You can also tempor incididunt ut labore et dolore magna aliqua sed do eiusmod eaque ipsa.</p>
																</div>
															</div>
														</div>
														<div class="accordion-item accordion-item-s4 bg-theme-alt">
														...
														<div class="accordion-item accordion-item-s4 bg-theme-alt">
															<h5 class="accordion-title collapsed" data-toggle="collapse" data-target="#faq-67-3"> How can I participate in the Cryptonium Token sale? <span class="accordion-icon accordion-icon-s2"></span>
															</h5>
														...
														<div class="accordion-item accordion-item-s4 bg-theme-alt">
															<h5 class="accordion-title collapsed" data-toggle="collapse" data-target="#faq-67-4"> How do I benefit from the Cryptonium Token? <span class="accordion-icon accordion-icon-s2"></span>
															</h5>
